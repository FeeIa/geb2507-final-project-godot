...
The game consists of two levels in the final prototype delivery for submission.
...
## Run in Godot
- Engine: Godot 4.5
- Clone this repository as a ZIP file, then extract as a folder.
- Open the extracted folder in Godot.
- Click the Run button to launch the main scene of the game.

## Purpose & Learning Goals
- Visualize immune system through approachable, game-forward mechanics.
...
- Knowledge gains were significant (pre/post 4.96 $\to$ 8.29), meeting the educational objective.
...
## Gameplay
- Deploy immune units (e.g., macrophage, B-cells, etc.) to attack waves of pathogens (viruses, bacterias, etc.)
...
## Game Design Process
- Iterative loops of prototype $\to$ internal playtest $\to$ balance tweaks to pacing and resource costs.
- UI refinements focused on readability and a pastel-like and pixel-like to match the 2D game atmosphere.
